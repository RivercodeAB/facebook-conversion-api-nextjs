 ...
 * @constructor
 */
const sendServerSideEvent = ({ eventName, eventId, emails, phones, products, value, currency, fbc, fbp, ipAddress, userAgent, sourceUrl, testEventCode, firstName, lastName }) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const eventData = [{
            ...
            user_data: Object.assign(Object.assign(Object.assign(Object.assign({ client_ip_address: ipAddress, client_user_agent: userAgent }, (emails && (emails === null || emails === void 0 ? void 0 : emails.length) > 0 && {
                em: emails.map((email) => ((0, hash_1.sha256Hash)(email))),
            })), { fn: firstName ? (0, hash_1.sha256Hash)(firstName.toLowerCase()) : undefined, ln: lastName ? (0, hash_1.sha256Hash)(lastName.toLowerCase()) : undefined }), (phones && (phones === null || phones === void 0 ? void 0 : phones.length) > 0 && {
