...
const eventHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { eventName, eventId, emails, phones, products, value, currency, userAgent, sourceUrl, testEventCode, fbc, firstName, lastName } = req.body;
    ...
    const payload = {
        ...
        fbc: fbc !== null && fbc !== void 0 ? fbc : (0, request_1.getClientFbc)(req),
